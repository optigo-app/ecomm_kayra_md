  ...
  return (
    <div>
                                ...
                                {chunkedData.map((chunk, index) => (
                                        <div className='linkRingLove'>
                                            ...
                                            <div className='smr_bestselerDiv'>     
                                                ...
                                                alt={`BestSeller-original-collection-${dataIndex}`}
        ...
        <div className='linkingLoveImage'>
            <img src={`${storImagePath()}/images/HomePage/BestSeller/promoSetMainBanner.png`} className='linkingLoveImageDesign' alt='banner-image-besteller' />
        </div>
    </div>
    </div>
}

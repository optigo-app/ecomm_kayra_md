...
import { CartCount, WishCount,  smr_companyLogo, smr_loginState } from '../../../Recoil/atom';
            ...
            <div className='smiling_Top_header'>
                <div className='smiling_Top_header_sub'>
                    <div className='smiling_Top_header_div2'>
                        <a href="/">
                            <img src={compnyLogo} loading='lazy' className='smr_logo_header' alt='company logo desktop' />
                        </a>
                    </div>
                ...
                >
                    <div className='smiling_Top_header_sub' style={{ width: '100%' }}>
                        <div className='smiling_Top_header_div2'>
                            <a href="/">
                                <img src={compnyLogo} loading='lazy' className='smr_logo_header_Fixed' alt='company logo desktop'  />
                            </a>
                        </div>
                        <div className='smiling_Top_header_div1'>
                            <ul className="nav_ul_shop">

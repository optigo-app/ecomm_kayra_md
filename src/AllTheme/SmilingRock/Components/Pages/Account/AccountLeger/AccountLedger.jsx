                                    ...
                                    <tbody className='fs_td'>
                                        ...
                                        }
                                        {
                                            filterArray?.length > 0
                                                ? filterArray
                                                    // First, group and sort by date, ensuring debit items come first within each date
                                                    .sort((a, b) => {
                                                        if (new Date(a.EntryDate) !== new Date(b.EntryDate)) {
                                                            return new Date(a.EntryDate) - new Date(b.EntryDate); // Sort by date first
                                                        }
                                                        return a.IsDebit === 1 ? -1 : 1; // Debit items come first
                                                    })
                                                    .map((e, index) => {
                                                        let icon = null;

                                                        // Check the debit/credit status and set the icons
                                                        ...
                                                        return (
                                                            <>
                                                                {e === 'Data Not Present' ? (
                                                                    ...
                                                                    <tr className="border_Acc" key={e?.id} style={{ fontFamily: 'Spectral-Regular' }}>
                                                                        {/* Show date only for Debit items */}
                                                                        <td className="border_end_acc p_1_acc text_center_acc">
                                                                            {e?.IsDebit === 0 ? '' : e?.EntryDate}
                                                                        </td>

                                                                        {/* Show particular only for Debit items */}
                                                                        <td className="border_end_acc p_1_acc text_start_acc ps_1_acc">
                                                                            {e?.IsDebit === 0 ? '' : e?.particular}
                                                                        </td>

                                                                        {/* Show reference number or voucher number for Debit items */}
                                                                        <td
                                                                            className={`border_end_acc p_1_acc text_start_acc ps_1_acc ${e?.PrintUrl === '' ? '' : 'text-primary text-decoration-underline'
                                                                                }`}
                                                                            style={{ cursor: 'pointer' }}
                                                                            onClick={() => (e?.PrintUrl === '' ? '' : e?.IsDebit === 1 && window.open(atob(e?.PrintUrl)))}
                                                                        >
                                                                            {e?.IsDebit === 0
                                                                                ? ''
                                                                                : e?.referenceno === ''
                                                                        ...
                                                                        {/* Show metal and diamond details only for Debit items */}
                                                                        <td className="border_end_acc p_1_acc text_end_acc pe_1_acc">
                                                                            {e?.IsDebit === 0 ? '' : e?.metalctw === 0 ? '' : e?.metalctw}
                                                                        </td>
                                                                        <td className="border_end_acc p_1_acc text_end_acc pe_1_acc">
                                                                            {e?.IsDebit === 0 ? '' : e?.diamondctw === 0 ? '' : e?.diamondctw}
                                                                        </td>

                                                                        {/* Show currency for Debit items */}
                                                                        <td className="border_end_acc p_1_acc text_end_acc pe_1_acc" style={{ minWidth: '100px' }}>
                                                                            {e?.IsDebit !== 0 && <span dangerouslySetInnerHTML={{ __html: currencyCode }}></span>}
                                                                            {e?.IsDebit === 0
                                                                                ? ''
                                                                                : ` ${formatAmount(e?.Currency) === 'NaN' ? '' : formatAmount(e?.Currency)} `}
                                                                        </td>

                                                                        {/* Show verification icon */}
                                                                        <td className="border_end_acc p_1_acc text_center_acc">{e?.IsDebit === 1 && icon}</td>

                                                                        {/* Show date for Credit items */}
                                                                        <td className="border_end_acc p_1_acc text_center_acc">
                                                                            {e?.IsDebit === 0 ? e?.EntryDate : ''}
                                                                        </td>

                                                                        {/* Show particular for Credit items */}
                                                                        <td className="border_end_acc p_1_acc text_start_acc ps_1_acc">
                                                                            {e?.IsDebit === 0 ? e?.particular : ''}
                                                                        </td>

                                                                        {/* Show reference number or voucher number for Credit items */}
                                                                        <td
                                                                            className={`border_end_acc p_1_acc text_start_acc ps_1_acc ${e?.PrintUrl === '' ? '' : 'text-primary text-decoration-underline'
                                                                                }`}
                                                                            onClick={() => (e?.PrintUrl === '' ? '' : e?.IsDebit === 0 && window.open(atob(e?.PrintUrl)))}
                                                                            style={{ cursor: 'pointer' }}
                                                                        >
                                                                            {e?.IsDebit === 0 ? e?.referenceno === '' ? e?.voucherno : e?.referenceno : ''}
                                                                        </td>

                                                                        {/* Show metal and diamond details for Credit items */}
                                                                        <td className="border_end_acc p_1_acc text_end_acc pe_1_acc">
                                                                            {e?.IsDebit === 0 ? (e?.metalctw === 0 ? '' : e?.metalctw) : ''}
                                                                        </td>
                                                                        <td className="border_end_acc p_1_acc text_end_acc pe_1_acc">
                                                                        ...
                                                                        {/* Show currency for Credit items */}
                                                                        <td className="border_end_acc p_1_acc text_end_acc pe_1_acc" style={{ minWidth: '100px' }}>
                                                                            {e?.IsDebit === 0 && <span dangerouslySetInnerHTML={{ __html: currencyCode }}></span>}
                                                                            {e?.IsDebit === 0 ? ` ${e?.Currency === 0 ? ' 0.00' : formatAmount(e?.Currency)}` : ''}
                                                                        </td>

                                                                        {/* Show verification icon for Credit items */}
                                                ...
                                                : (
                                                    <tr style={{ fontFamily: 'Spectral-Regular' }}>
                                                        <td align="center" colSpan={18} style={{ color: 'grey', fontWeight: 'bold' }}>
                                                            Data Not Present
                                                        </td>
                                                    </tr>
                                                )

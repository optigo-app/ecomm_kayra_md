...
const DfineprivacyData = {
    introduction: {
        text: "At Dfine, your privacy and trust are our highest priorities. We are committed to protecting the personal information you share with us. This Privacy Policy outlines how we collect, use, store, and protect your personal data when you visit our website, make a purchase, or engage with us in any other way."
    },
    sections: [
        {
            title: "Information We Collect",
    ...
    conclusion: {
        text: "At Dfine, we value your privacy and are dedicated to ensuring that your personal information is handled with care. If you have any questions or concerns about this Privacy Policy, please don't hesitate to reach out to us."
    }
};
 ...
 if(IsCurrentThemeState === "1"){
    ...
    return (
        <div className='smr_priv_mainDiv'>
            <div className='daimondsEverypriv'>
                <div className='smr_daimondsEverypriv_sub' style={{ paddingBottom: '80px', minHeight: '400px' }}>

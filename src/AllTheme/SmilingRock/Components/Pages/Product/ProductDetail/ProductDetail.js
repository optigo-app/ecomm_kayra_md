...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    let decodeobj = decodeAndDecompress(navVal);
    console.log("TCL: decodeobj", decodeobj)
    ...
    const FetchProductData = async () => {
      ...
      setSingleProd1({})
      setSingleProd({})
      // (sizeData == undefined ? decodeobj?.e : sizeData)
  ...
  console.log("kjiji", singleProd1?.Labour_Cost ?? singleProd?.Labour_Cost)
      ...
      <div className="smr_prodDetail_bodyContain">
        <div className="smr_prodDetail_outerContain">
          <div className="smr_prodDetail_whiteInnerContain">
            {!prodLoading && <button className="mobile_backbuton_smr_nav" onClick={goBack}><ArrowBackIcon fontWeight={600} /></button>}
            {isDataFound ? (
              <div
                style={{
                  height: "90vh",
                    ...
                    <div className="smr_prod_image_Sec">
                      ...
                      >
                        ...
                        <div className="smr_main_thumb_prod_img" >
                          {!prodLoading && <button className="backbuton_smr_nav" onClick={goBack}><ArrowBackIcon fontWeight={600} /></button>}
                              ...
                              >
                                ...
                                <tr>
                                  ...
                                  {(singleProd1?.Other_Cost
                                    ...
                                    (singleProd1?.SizeMarkUpAmount
                                      ? singleProd1?.SizeMarkUpAmount
                                      : singleProd?.SizeMarkUpAmount) +
